...
export const initialInvoices = [
  ...
  },
  {
    ...
    invoiceNumber: "PUR-2026-012",
    customerName: "Dell India Hardware Supplies",
    customerGst: "33AAACD8811F1Z2",
    date: "2026-08-20",
    dueDate: "2026-09-03",
    subtotal: 120000,
    cgst: 10800,
    ...
    status: "Paid",
    items: [
      { description: "Dell XPS 15 Office Laptops", hsnSac: "847130", quantity: 2, unitPrice: 60000, taxPercent: 18, amount: 120000 },
    ]
  },
  {
    id: "EST-2026-005",
    documentType: "Estimate",
    invoiceNumber: "EST-2026-005",
    ...
    status: "Pending",
    items: [
      { description: "Annual GST Audit & Tax Compliance Package", hsnSac: "998221", quantity: 1, unitPrice: 45000, taxPercent: 18, amount: 45000 }
    ]
  },
  {
    id: "DC-2026-003",
    documentType: "Delivery Challan",
    invoiceNumber: "DC-2026-003",
    ...
    status: "Paid",
    items: [
      { description: "Server Storage Drives Dispatch", hsnSac: "847170", quantity: 5, unitPrice: 13000, taxPercent: 18, amount: 65000 }
    ]
  },
  {
    id: "PAY-2026-001",
    ...
    customerName: "Acme Global Solutions",
    paidBy: "Acme Global Solutions",
    paidTo: "Chinna Durai (Durai Tax Advisory)",
    paymentMethod: "Bank Transfer (NEFT/RTGS)",
    paymentPurpose: "Monthly Tax Advisory & Audit Settlement",
    customerGst: "29AABCA1234B1Z2",
    date: "2026-08-25",
    subtotal: 59000,
    cgst: 0,
    ...
    status: "Completed",
    items: [
      { description: "Monthly Tax Advisory & Audit Settlement", hsnSac: "N/A", quantity: 1, unitPrice: 59000, taxPercent: 0, amount: 59000 }
    ]
  }
];
